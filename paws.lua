...
local resources_dir =  filesystem.resources_dir() .. '\\paws\\'
...
menu.my_root():toggle("Bark", {}, "", function(on)
    do_bark = on
end, true)

menu.my_root():slider_float('Corgi Y', {}, "", -100, 100, 79, 1, function(value)
    corgi_y = value * 0.01
end)

menu.my_root():slider_float("Corgi home X", {}, "If your corgi gets too far from their home, or goes behind it, they will correct their course and go back", -100, 100, 2, 1, function(value)
    corgi_home_x = value * 0.01
    corgi_x = corgi_home_x
end)


menu.my_root():slider_float("Max wanted distance from home", {}, "", -100, 100, 10, 1, function(value)
    max_dist = value * 0.01
end)
...
menu.my_root():list_select("Choose Skin", {}, "Select a skin for the corgi", skin_folders, 1, function(index, value)
